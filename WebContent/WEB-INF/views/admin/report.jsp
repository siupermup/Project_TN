...
<body>
	...
	<div class="content-wrapper">
		...
		<form method="get" action="homeAdmin/report.php">
			From: <input type="date" name="start" value="${sta}">
		...
		<table class="table table-striped table-bordered " id="table">
			<thead >
				<tr >
					<th><Strong class="card-title text-primary">Số lượng bán</strong></th>
					<th><Strong class="card-title text-primary">Tên hãng điện thoại</strong></th>
				</tr>
			</thead>
			<tbody>
				<c:forEach var="p1" items="${result}">
					<tr>
						<td>${p1[0]}</td>
						<td>${p1[1]}</td>
					</tr>
