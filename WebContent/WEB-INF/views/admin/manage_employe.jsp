...
<div class="card-body">
			...
			<form action="" method="post">
				...
				<a href="homeAdmin/product/shipper_form.php">
					...
					<table class="table table-striped table-bordered " id="table">
						<thead >
							<tr >
								...
								<th style="text-align: center;"><Strong class="card-title text-primary">Staff User ID</strong></th>
								<th style="text-align: center;"><Strong class="card-title text-primary">Passwword</strong></th>
								...
								<tr>
									...
									<td>
										<div style="text-align: center;">
											<a class="" href="homeAdmin/product/delProduct/${p.getShipperID()}.php" title="delete"><i
												class="mdi mdi-delete-forever"></i></a> <a class="" href="homeAdmin/product/editpro/${p.getShipperID()}.php"
