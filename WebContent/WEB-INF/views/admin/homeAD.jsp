...
<body>
	...
	<div class="content-wrapper">
		...
		<form method="get" action="homeAdmin/report.php">
			From: <input type="date" name="start" value="">
			To: <input type="date" name="end" value="">
			<input type="submit" value="Submit">
		</form>
		<table class="table table-striped table-bordered " id="table">
			<thead >
				<tr >
					<th><Strong class="card-title text-primary">Số lượng bán trong 7 ngày gần nhất</strong></th>
					<th><Strong class="card-title text-primary">Tên hãng điện thoại</strong></th>
				</tr>
			</thead>
			<tbody>
				<c:forEach var="p1" items="${data}">
					<tr>
						<td>${p1[0]}</td>
						<td>${p1[1]}</td>
					</tr>
...
function myFunction1() {
  var x = new Date();
  document.getElementsByClassName("end").innerHTML = x
}
</script>
</body>
